...
AGGIUNGI MODELLO POLINOMIALE VARIABILI

\Sexpr{knit_child("documentation/interazione_variabili.Rnw")}

\Sexpr{knit_child("documentation/selezione_modello.Rnw")}

\Sexpr{knit_child("documentation/test_modello.Rnw")}

\Sexpr{knit_child("documentation/visualizzazione_modello.Rnw")}

\Sexpr{knit_child("documentation/modelli_grafici.Rnw")}
